...
const useCamapaign = () => {
  ...
  return { campaign, fundCampaign, amount, setAmount, loading };
};

export default function Campaign() {
  const { campaign, fundCampaign, amount, setAmount, loading } = useCamapaign();
  return (
        ...
        <div className="flex-[1/3]">
          ...
          <div className="mt-8">
            ...
            <small className="text-[0.75rem]">
              Note that once you fund the campaign you will not able to refund
